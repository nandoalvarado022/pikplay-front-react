...
const TopNavbar = props => {
  return (
    <div className={'view_TopNavBar font-b'}>
      <h3>
        ...
        {props.feed &&
          props.feed.map((item, ind) => {
            ...
            if (item.tipo_coleccion == 'preguntas') {
              href = {
                pathname: '/pregunta',
                query: { preguntaDetalle: JSON.stringify(item) },
              }
