...
const Usuario = (props) => {
  ...
  const starUserImg = 'https://cdn5.vectorstock.com/i/1000x1000/90/29/vip-member-premium-user-icon-on-white-vector-34649029.jpg'
  const activeUserImg = "https://cdn-icons-png.flaticon.com/512/7036/7036984.png"
    ...
    <section id={styles.usuario}>
      ...
      >
        ...
        <p className={styles.description}>
          ...
          ▶CC. Diamante local 1387
          🚚Envíos a Domicilio a nivel nacional
          ▶Sistema de Crédito 💳
          www.gamestopmedellin.com
