...
const CiudadControl = () => {
  ...
  return <div className="contentCiudad">
    <Autocomplete value={user.city} name="str_ciudad" options={listadoCiudades} onInputChange={(event, str_ciudad) => { customDispatch({ type: "CHANGE_PROPERTY", payload: { property: "user", value: { ...user, city: str_ciudad } } }) }} getOptionLabel={(option) => option} style={{ width: "100%" }}
