...
const CiudadControl = () => {
  ...
  const defaultValue = user.city ? listadoCiudades.find((item) => item.id === user.city) : listadoCiudades[0]
  const onInputChange = (event, value) => {
    dispatch({ type: "CHANGE_PROPERTY", payload: { property: "user", value: { ...user, city: value.id } } })
  }
