...
const Notification = ({ }) => {
    ...
    const { id = null, isHiddenButton, message: htmlMessage = null } = messageModal
    const handleClose = () => {
        dispatch({ type: "SET_MESSAGE", payload: null })
    }
    const isNotificationChecked = checkedNotifications && !checkedNotifications.find(item => item == id)
