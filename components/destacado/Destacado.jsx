...
const Destacado = props => {
  ...
  datosMostrar = data.find(
    item =>
      item.tipo_coleccion == tipo_coleccion &&
      (item.tipo_publicacion
        ? item.tipo_publicacion == props.filtroActive.tipo_publicacion
        : true),
  )
  ...
  return (
    <div className='_Destacado'>
      <img
        alt='Imagen de publicacion destacada'
        data-aos='fade-up-right'
        src={datosMostrar.imagen}
      />
      <div className='textos'>
        <p>
          <h2
            data-aos='fade-left'
            className='font-c animated infinite bounce delay-2s'
          >
            {datosMostrar.titulo}
          </h2>
