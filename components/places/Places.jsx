...
const Places = () => {
    const places = [{
        ...
        city: 'medellin',
        image: 'https://telemedellin.tv/wp-content/uploads/2020/05/IMG_4444-1024x640-1.jpg',
    ...
    },
    {
        address: 'Cl. 45 ##1-85',
        city: 'barranquilla',
        image: 'https://fastly.4sqi.net/img/general/600x600/51140435_S1UjdPhfEe-hEwHfw7omuI1W8LEq93TlmWtxB7L8lrE.jpg',
        name: 'Centro Comercial Metrocentro',
        nickname: 'ME'
    }]
    const cities = getCiudades()

    return <div className={styles.PlacesComponent}>
