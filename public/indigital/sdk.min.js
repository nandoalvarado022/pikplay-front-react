!(function (t) {
    ...
    var n = r(2),
      ...
      f = function t(e, r, f) {
        var u,
          ...
          b = e & t.P,
          v = e & t.B,
          y = p ? n : e & t.S ? n[r] || (n[r] = {}) : (n[r] || {}).prototype,
          g = p ? i : i[r] || (i[r] = {}),
        ...
        ;(a.isBN = function (t) {
          ...
          (a.prototype._init = function (t, r, n) {
            ...
            '-' === (t = t.toString().replace(/\s+/g, ''))[0] && o++,
              16 === r ? this._parseHex(t, o) : this._parseBase(t, r, o),
              '-' === t[0] && (this.negative = 1),
              this.strip(),
        ...
        ;(g.prototype._tmp = function () {
          ...
          (E.prototype.sqrt = function (t) {
            ...
            for (
              ...
              i(v < p)
              var y = this.pow(h, new a(1).iushln(p - v - 1))
        ...
        (t.exports = function (t, e, r, n) {
          ...
          m
            ...
            : (a(function () {
              ...
              i || (E.constructor = p))
          var A = E[bt],
            x = !!A && ('values' == A.name || void 0 == A.name),
            T = jt.values
          l(p, yt, !0),
            l(E, _t, u),
            l(E, wt, !0),
  ...
  function (t, e, r) {
    ...
    t.exports = {
      ...
      key: function (t) {
        return void 0 === t || 'symbol' == (void 0 === t ? 'undefined' : n(t))
          ? t
          : String(t)
      },
      exp: function (t) {
      ...
      ;(f.prototype.slice = function (t, e) {
        ...
        (f.prototype.fill = function (t, e, r, n) {
          ...
          if (
            ...
            var a = f.isBuffer(t) ? t : F(new f(t, n).toString()),
              s = a.length
      ...
      return (
        n(t, [
          ...
          },
          {
            ...
            value: function () {
              var t = o.default.getItem(this.SERVICE_SYNC_TIME)
          ...
          },
          {
            ...
            value: function () {
              var t = o.default.getItem(this.LOCATION_UPDATE_MINUTES)
              return t || 30
            },
          },
          {
          ...
          },
          {
            key: 'getDebugLog',
            value: function () {
              return 'false' !== o.default.getItem(this.SET_LOG_DEBUG)
            },
          },
        ]),
        t
  ...
  function (t, e, r) {
    ...
    var n = r(20),
      ...
      u = {},
      c = {},
      h = (t.exports = function (t, e, r, h, d) {
        var l,
          p,
          b,
          v,
  ...
  function (t, e, r) {
    'use strict'
    Object.defineProperty(e, '__esModule', { value: !0 })
    var n = { platform: 'webpush', version: '0.0.1' },
      i = r(363)
    ;(n.version = i.version),
      (n = Object.assign(n, {
        client: {
  ...
  function (t, e, r) {
    ...
    var o = Object.freeze({ DEBUG: 1, WARNING: 3, ERROR: 4 }),
      a = (function () {
        function t(e) {
          !(function (t, e) {
            if (!(t instanceof e))
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e, r, b, v, y, g) {
      ...
      var m,
        ...
        A = (!l && k) || S(v),
        x = v ? (M ? S('entries') : A) : void 0,
        T = ('Array' == e && P.entries) || k
      if (
        (T &&
  ...
  function (t, e, r) {
    ...
    function K(t, e, r, n, i, o) {
      ...
      for (var s = t[R]._b, f = a + t[B], u = n(+i), c = 0; c < e; c++)
        s[f + c] = u[o ? c : e - c - 1]
    }
    if (a.ABV) {
      if (
    ...
    t.exports =
      ...
      function (t, e) {
        var r = n(this),
          ...
          c = Math.min((void 0 === u ? a : i(u, a)) - f, a - s),
          h = 1
        for (
  ...
  function (t, e, r) {
    ...
    var n,
      ...
      g = (t.exports = r(67)('WeakMap', v, y, f, !0, !0))
    c(function () {
      return 7 != new g().set((Object.freeze || Object)(b), 7).get(b)
    }) &&
  ...
  function (t, e, r) {
    ...
    for (
      ...
      p(tt[et++])
    for (var rt = A(p.store), nt = 0; rt.length > nt; ) v(rt[nt++])
    s(s.S + s.F * !z, 'Symbol', {
      for: function (t) {
      ...
      'Array',
      {
        slice: function (t, e) {
          ...
          for (
            ...
            h[d] = 'String' == n ? this.charAt(i + d) : this[i + d]
          return h
        },
      },
    )
    ...
    r(89)(u, 'RegExp String', function () {
      ...
      n(n.P, 'String', {
        matchAll: function (t) {
          ...
          var e = String(this),
            r = 'flags' in f ? String(t.flags) : s.call(t),
    ...
    ;(function (t, e) {
      ...
      !(function (t) {
        ...
        if (h) c && (e.exports = h)
          ...
          var _ = (I.prototype = E.prototype = Object.create(y))
          ...
          n(t, [
            {
              ...
              value: function () {
                return new Promise(function (t, e) {
                  ...
                  if (r) {
                    var n = r.open('indigitall.indexedDB', 1)
                    ;(n.onupgradeneeded = function () {
                      ...
                      (n.onsuccess = function () {
                        var e = n.result,
                          r = e.transaction('indigitallStore', 'readwrite'),
                          i = r.objectStore('indigitallStore'),
                          o = i.index('storeIndex')
  ...
  function (t, e, r) {
    'use strict'
    Object.defineProperty(e, '__esModule', { value: !0 })
    var n = Object.freeze({ DEFAULT: -1, ENABLE: 1, DISABLE: 0 })
    e.default = n
  },
  function (t, e, r) {
    'use strict'
    ...
    n.inherits(g, v),
      ...
      (g.prototype._update = function (t, e) {
        ...
        for (a(this.k.length === r.length), n = 0; n < r.length; n++) {
          var S = u(w, l(g), c(g, m, _), this.k[n], r[n]),
            E = s(d(i), h(i, o, v))
          ;(w = _),
            (_ = m),
            (m = g),
      ...
      (m.prototype._update = function (t, e) {
        ...
        for (var B = 0; B < r.length; B += 2) {
          var N = R,
            ...
            z = r[B],
            V = r[B + 1],
            K = b(N, C, L, D, j, U, F, q, z, V),
            Y = v(N, C, L, D, j, U, F, q, z, V)
          ;(N = M(n, i)),
            (C = I(n, i)),
            (L = S(n, i, a, s, f)),
            (D = E(n, i, a, s, f, u))
    ...
    ;(t.exports = f),
      ...
      (u.prototype._skipUntilEnd = function (t, e) {
        for (;;) {
          ...
          if (
            ((n =
              r.primitive || null !== i ? t.skip(i) : this._skipUntilEnd(t, e)),
            t.isError(n))
          )
            return n
  ...
  function (t, e, r) {
    ...
    ;(t.exports = f),
      ...
      (u.prototype._encodeComposite = function (t, e, r, n) {
        ...
        u = 1 + f
        for (var c = n.length; c > 0; u--, c >>= 8) o[u] = 255 & c
        ...
        return (
          n(t, null, [
            ...
            },
            {
              ...
              value: function (e) {
                var r = new v.default(g)
                if ('default' === e.permission) {
                  var n = { deviceCode: i.default.getDeviceId() }
            ...
            },
            {
              ...
              value: function (e, r) {
                var n = new v.default(g)
                if (
                  i.default.getSafariWebsitePushId() &&
                  i.default.getDeviceId()
                ) {
                  var o = window.safari.pushNotification.permission(
                    i.default.getSafariWebsitePushId(),
                  )
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var o = r(427),
                  a = t,
                  s = ''
                null != i.default.getAppKey() && (s = i.default.getAppKey())
                var f = o.createHmac('sha256', s).update(a).digest('hex'),
                  c = new h.default()
  ...
  function (t, e, r) {
    ...
    ;(function (e, n) {
      ...
      t.exports = function (t, r, l, p, b, v) {
        ...
        if ((o(t, r, l, p), 'function' != typeof v))
    ...
    ;(n.assert = o),
      ...
      (n.getNAF = function (t, e) {
        for (var r = [], n = 1 << (e + 1), i = t.clone(); i.cmpn(1) >= 0; ) {
          ...
          r.push(o)
          for (
            var s = 0 !== i.cmpn(0) && 0 === i.andln(n - 1) ? e + 1 : 1, f = 1;
            f < s;
            f++
          )
            r.push(0)
    ...
    ;(t.exports = f),
      ...
      (f.prototype._wnafMulAdd = function (t, e, r, n, i) {
        ...
        for (h = c; h >= 0; h--) {
          for (var E = 0; h >= 0; ) {
            var M = !0
            for (g = 0; g < n; g++) (S[g] = 0 | u[g][h]), 0 !== S[g] && (M = !1)
            if (!M) break
            E++, h--
          }
          ...
          for (g = 0; g < n; g++) {
            ...
            0 !== P &&
              (P > 0
                ? (I = f[g][(P - 1) >> 1])
                : P < 0 && (I = f[g][(-P - 1) >> 1].neg()),
              (w = 'affine' === I.type ? w.mixedAdd(I) : w.add(I)))
          }
        }
        ...
        if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
          ...
          if (t.lambda) r = new o(t.lambda, 16)
            ...
            0 === this.g.mul(i[0]).x.cmp(this.g.x.redMul(e))
              ? (r = i[0])
              : ((r = i[1]), f(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))))
          }
          return {
            beta: e,
            lambda: r,
  ...
  function (t, e, r) {
    ...
    function u(t, e) {
      ;(this.eddsa = t),
        'object' !== (void 0 === e ? 'undefined' : n(e)) && (e = f(e)),
        Array.isArray(e) &&
          (e = {
  ...
  function (t, e, r) {
    ...
    var n =
      ...
      i = r(151).Reporter,
      o = r(151).EncoderBuffer,
      a = r(151).DecoderBuffer,
      s = r(53),
      f = [
        'seq',
        'seqof',
    ...
    ;(c.prototype.clone = function () {
      ...
      (c.prototype.explicit = function (t) {
        var e = this._baseState
        return (
          s(null === e.explicit && null === e.implicit), (e.explicit = t), this
        )
      }),
      (c.prototype.implicit = function (t) {
        var e = this._baseState
        return (
          s(null === e.explicit && null === e.implicit), (e.implicit = t), this
        )
      }),
      ...
      (c.prototype._encodeValue = function (t, e, r) {
        ...
        if (!o.any && null === o.choice) {
          ...
          null === c
            ...
            : null === o.use && (a = this._encodeComposite(c, f, h, s))
        }
        return (
          null !== o.explicit &&
      ...
      if (4 === d)
        l = (function (t, e) {
          ...
          var l = h.alloc(r - n - d - 2),
            p = r - c - 1,
            b = i(c),
            v = s(h.concat([u, l, h.alloc(1, 1), e], p), a(b, p)),
            y = s(b, a(v, c))
