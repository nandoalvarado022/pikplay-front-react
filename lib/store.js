...
const reducer = (state = initialState, action) => {
    ...
    switch (type) {
        ...
        case "SET_MESSAGE":
            ...
            notifications = localStorage.getItem("checkedNotifications") ? JSON.parse(localStorage.getItem("checkedNotifications")) : []
...
const persistedReducer = persistReducer({
    key: 'pikplay',
    storage,
    whitelist: ['user', 'token', 'modal_lead', 'publication_form'] // only these reducers will be persisted
}, reducer)
